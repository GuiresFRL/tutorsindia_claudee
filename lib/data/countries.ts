// Full country list with ISO-3166 alpha-2 codes and E.164 calling codes.
// Flags are derived from the ISO2 code (regional indicator symbols), so no emoji is hardcoded.

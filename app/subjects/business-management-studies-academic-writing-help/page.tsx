...
export default function BusinessManagementWritingPage() {
  return (
    <main style={{ color: "#222" }}>
      ...
      <BreadcrumbSchema items={[{ name: "Home", url: "/" }, { name: "Subjects", url: "/subjects/" }, { name: "Business & Management Studies" , url: "https://www.tutorsindia.com/subjects/business-management-studies-academic-writing-help/" }]} />
      {/* Hero */}

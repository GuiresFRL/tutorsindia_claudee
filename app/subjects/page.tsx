...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.tutorsindia.com/subjects/" },
};
...
export default function SubjectsPage() {
  return (
    <>
      <BreadcrumbSchema items={[{ name: "Home", url: "/" }, { name: "Subjects" , url: "https://www.tutorsindia.com/subjects/" }]} />
      ...
      <section style={{ background: "#e87722", color: "#fff", padding: "52px 20px", textAlign: "center" }}>
        <h2 style={{ fontSize: "clamp(1.4rem,3vw,1.9rem)", fontWeight: 700, marginBottom: "8px" }}>Invest in Your Career — Get A Free Quote Today</h2>

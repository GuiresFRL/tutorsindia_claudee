...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      url: `https://tutorsindia.com/academy/${slug}/`,
  ...
  return (
    <>
          ...
          <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
            ...
            <div className="related-grid">
              {related.map((rp) => {
                ...
                return (
                  <Link key={rp.id} href={`/academy/${rp.slug}/`} style={{ display: "block", background: "#fff", border: "1px solid #dde2ef", borderRadius: "12px", overflow: "hidden", boxShadow: "0 2px 8px rgba(0,0,0,0.04)" }}>
      ...
      <style>{`
        ...
        .wp-content table { width: 100%; border-collapse: collapse; margin: 22px 0; font-size: 0.9rem; border-radius: 8px; overflow: hidden; }

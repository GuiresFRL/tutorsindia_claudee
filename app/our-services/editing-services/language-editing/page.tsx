...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.tutorsindia.com/our-services/editing-services/language-editing" },
};
...
const testimonials = [
  {
    quote: "I approached Tutors India for the second time to have my paper edited. I'm quite impressed with the editing quality and want to use Tutors India's services in the future. The editor performed an excellent job, and the crew that assisted me throughout the editing process was quite helpful.",
    author: "Dr. Henrik J. Olofsson, PhD",
  },
  {
    quote: "After evaluating a few outsourcers I decided to work with Tutors India because of their professional approach and ability to make changes about what I really needed in my language editing. Tutor India was very responsive to these changes. I am very satisfied with our engagement and would consider working together on future projects too. I appreciate their promptness and quality of work. Keep up the good work.",
    author: "Zoe",
  },
];
...
const editingLevels = [
  ...
  {
    feature: "Sentence construction",
    premium: true,
    advanced: true,
    standard: false,
  },
  {
    feature: "Terminology/reference check",
    premium: true,
    advanced: true,
    standard: false,
  },
  {
    feature: "Logic, relevance and clarity",
    premium: true,
    advanced: true,
    standard: false,
  },
  ...
  {
    feature: "Tutors India certificate",
    premiumLabel: "On request",
    premium: false,
    advanced: false,
    standard: false,
  },
...
export default function LanguageEditingPage() {
  return (
    <>
      ...
      <section style={{ background: "linear-gradient(135deg,#1a2a6c 0%,#2563b0 100%)", color: "#fff", padding: "64px 20px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ fontSize: "0.82rem", color: "#a0b8e0", marginBottom: "14px" }}>
            ...
            <span style={{ color: "#fff" }}>Language Editing</span>
          </div>
      ...
      {/* Our Guarantees / Service features */}
      <section style={{ background: "#1a2a6c", color: "#fff", padding: "3rem 1rem" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div className="three-col-grid">
            <div style={{ background: "rgba(255,255,255,.08)", borderRadius: "10px", padding: "1.75rem", borderTop: "3px solid #e87722" }}>
              <h3 style={{ color: "#f9c74f", fontWeight: 700, fontSize: "1rem", marginBottom: "0.75rem" }}>Usage</h3>
              <ul style={{ paddingLeft: "1.2rem", margin: 0 }}>
                <li style={{ color: "rgba(255,255,255,.85)", lineHeight: 1.8, marginBottom: ".4rem" }}>Errors correction in verb/subject and antecedent agreement</li>
                <li style={{ color: "rgba(255,255,255,.85)", lineHeight: 1.8, marginBottom: ".4rem" }}>Errors correction in phrasing and word choice.</li>
                <li style={{ color: "rgba(255,255,255,.85)", lineHeight: 1.8 }}>Checking for non-parallel structure, coordination, and subordination.</li>
              </ul>
            </div>
            <div style={{ background: "rgba(255,255,255,.08)", borderRadius: "10px", padding: "1.75rem", borderTop: "3px solid #e87722" }}>
              <h3 style={{ color: "#f9c74f", fontWeight: 700, fontSize: "1rem", marginBottom: "0.75rem" }}>Mechanics</h3>
              <ul style={{ paddingLeft: "1.2rem", margin: 0 }}>
                <li style={{ color: "rgba(255,255,255,.85)", lineHeight: 1.8, marginBottom: ".4rem" }}>Errors in spelling correction.</li>
                <li style={{ color: "rgba(255,255,255,.85)", lineHeight: 1.8, marginBottom: ".4rem" }}>Errors in punctuation correction.</li>
                <li style={{ color: "rgba(255,255,255,.85)", lineHeight: 1.8 }}>And at last scanning your document for plagiarism check.</li>
              </ul>
            </div>
            <div style={{ background: "rgba(255,255,255,.08)", borderRadius: "10px", padding: "1.75rem", borderTop: "3px solid #e87722" }}>
              <h3 style={{ color: "#f9c74f", fontWeight: 700, fontSize: "1rem", marginBottom: "0.75rem" }}>Our services include</h3>
              <ul style={{ paddingLeft: "1.2rem", margin: 0 }}>
                {[
                  ...
                  <li key={i} style={{ color: "rgba(255,255,255,.85)", lineHeight: 1.7, marginBottom: ".3rem", fontSize: ".9rem" }}>{item}</li>
                ))}
              </ul>
            </div>
          </div>
      ...
      {/* Editing levels comparison table */}
      <section style={{ background: "#fff", padding: "3rem 1rem" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
      ...
      <section style={{ background: "#f0f4ff", padding: "3rem 1rem" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <p style={{ color: "#333", lineHeight: 1.8, marginBottom: "1.25rem" }}>
            Through spell checks and general formatting
          </p>
      ...
      <section style={{ background: "#fff", padding: "3rem 1rem" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <div style={{ background: "#f0f4ff", borderRadius: "8px", padding: "1.5rem", borderLeft: "4px solid #e87722", marginBottom: "1.5rem" }}>
          ...
          <div className="three-col-grid">
            {[
              ...
              <div key={i} style={{ background: "#f0f4ff", borderRadius: "10px", padding: "1.5rem", borderTop: "3px solid #e87722" }}>
      ...
      <section style={{ background: "#1a2a6c", color: "#fff", padding: "3rem 1rem" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <p style={{ opacity: 0.9, lineHeight: 1.8 }}>
            Tutors india offers highest quality language editing works. We aim to attain absolute customer satisfaction with every order. We will assign a Ph.D. educated writer with experience in your specific area of academic study. The writer will thoroughly research and complete your paper to your exact specifications. Once your order is completed, our Language editing department will review the completed version to ensure it is error-free and meets our standards. Before the paper arrives at your email or CRM software we check it with the latest anti-plagiarism software to guarantee, your order is 100 % authentic work.
          </p>
        </div>
      </section>

...
export default function MedicalWritingPage() {
  return (
    <>
      <BreadcrumbSchema items={[{ name: "Home", url: "/" }, { name: "Services", url: "/our-services/" }, { name: "Publication Support", url: "/our-services/publication-support/" }, { name: "Medical Writing" , url: "https://www.tutorsindia.com/our-services/publication-support/medical-writing/" }]} />

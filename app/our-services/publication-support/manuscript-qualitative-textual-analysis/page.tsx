...
export default function ManuscriptQualitativeTextualAnalysisPage() {
  return (
    <>
      <BreadcrumbSchema items={[{ name: "Home", url: "/" }, { name: "Our Services", url: "/our-services/" }, { name: "Publication Support", url: "/our-services/publication-support/" }, { name: "Manuscript Statistics" }]} />
      {/* Hero */}

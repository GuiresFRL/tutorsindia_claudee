...
export default function PhDResearchPlanPage() {
  return (
    <>
      <BreadcrumbSchema items={[{ name: "Home", url: "/" }, { name: "Services", url: "/our-services/" }, { name: "PhD / DBA Dissertation", url: "/our-services/phd-dba-dissertation/" }, { name: "PhD Research Plan" , url: "https://www.tutorsindia.com/our-services/phd-dba-dissertation/phd-research-plan/" }]} />
      {/* ── HERO ── */}

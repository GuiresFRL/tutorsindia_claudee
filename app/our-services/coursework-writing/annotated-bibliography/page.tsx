...
export default function AnnotatedBibliographyPage() {
  return (
    <>
      <BreadcrumbSchema items={[{ name: "Home", url: "/" }, { name: "Services", url: "/our-services/" }, { name: "Coursework Writing", url: "/our-services/coursework-writing/" }, { name: "Annotated Bibliography" , url: "https://www.tutorsindia.com/our-services/coursework-writing/annotated-bibliography/" }]} />
      {/* ── HERO ── */}

...
const productSchema = {
  ...
  "@graph": [
    {
      "@type": "Product",
      name: "Master's Research Methodology Services",
      image: "https://www.tutorsindia.com/wp-content/uploads/2025/02/New-Project.jpg",
      description: "Professional research methodology services providing research design, qualitative and quantitative methodology, data collection strategies, sampling techniques, research framework development, statistical planning, and methodology writing support for master's and postgraduate coursework.",
      url: "https://www.tutorsindia.com/our-services/coursework-writing/research-methodology/",
      brand: {
        "@type": "Organization",
        name: "Tutors India",
        areaServed: [
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 4, name: "Research Methodology", item: "https://www.tutorsindia.com/our-services/coursework-writing/research-methodology/" },
  ],
};

    ...
    <>
      ...
      <div style={{ background: "#12214a", padding: "16px 20px" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto", display: "flex", gap: "28px", flexWrap: "wrap", justifyContent: "center" }}>
          {[{ n: "150+", l: "Expert CV Writers" }, { n: "25+", l: "Years Experience" }, { n: "Global", l: "Jobs Market Knowledge" }, { n: "Unlimited", l: "Revisions" }, { n: "100%", l: "Satisfaction Guarantee" }, { n: "30 min", l: "Response" }].map(s => (

  ...
  return (
    <section style={{ background: "#f0f4ff", padding: "56px 20px" }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        ...
        <div style={{ position: "relative", maxWidth: "760px", margin: "0 auto", background: "#fff", borderRadius: "12px", padding: "40px 56px", boxShadow: "0 4px 20px rgba(26,42,108,0.1)", minHeight: "180px", textAlign: "center" }}>
          <p style={{ color: "#444", fontSize: "0.98rem", lineHeight: 1.8, fontStyle: "italic", marginBottom: "20px" }}>&ldquo;{t.quote}&rdquo;</p>
          <div style={{ fontWeight: 700, color: "#1a2a6c", fontSize: "0.9rem" }}>— {t.name}{t.location ? `, ${t.location}` : ""}</div>

...
export default function StatisticalAnalysisQAPage() {
  return (
    <>
      <BreadcrumbSchema items={[{ name: "Home", url: "/" }, { name: "Coursework", url: "/our-services/coursework-writing/" }, { name: "Statistical Analysis" , url: "https://www.tutorsindia.com/coursework/statistical-analysis/" }]} />
      ...
      <section style={{ background: "linear-gradient(135deg,#1a2a6c 0%,#2563b0 100%)", color: "#fff", padding: "44px 20px", textAlign: "center" }}>
        ...
        <p style={{ color: "#c5d5f0", fontSize: "0.96rem", marginBottom: "18px" }}>Our PhD statisticians provide comprehensive support from data collection to final interpretation.</p>

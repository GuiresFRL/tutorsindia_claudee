...
export default async function TopicPage() {
  ...
  return (
    <>
      <BreadcrumbSchema items={[{ name: "Home", url: "/" }, { name: "Dissertation Topics" , url: "https://www.tutorsindia.com/topic/" }]} />
      {/* Hero */}
      <section style={{ background: "linear-gradient(135deg,#1a2a6c 0%,#2563b0 100%)", color: "#fff", padding: "52px 20px 44px" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          <div style={{ fontSize: "0.82rem", color: "#a0b8e0", marginBottom: "12px" }}>
            ...
            <span style={{ color: "#fff" }}>Dissertation Topics</span>
          </div>
          ...
          <p style={{ color: "#c5d5f0", fontSize: "0.97rem", maxWidth: "680px", marginBottom: "6px" }}>
            Browse free dissertation topic ideas across {pages.length} subject areas. Expert-curated and updated regularly.
          </p>
        ...
        <div className="three-col-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "20px" }}>
          {pages.map((p) => (
            ...
            >
              ...
              <span style={{ marginTop: "14px", fontSize: "0.82rem", color: "#e87722", fontWeight: 700 }}>View Topics →</span>
            </Link>
          ))}
        </div>
      ...
      <section style={{ background: "linear-gradient(135deg,#1a2a6c 0%,#2563b0 100%)", color: "#fff", padding: "48px 20px", textAlign: "center" }}>
        <h2 style={{ fontFamily: "Merriweather,serif", fontSize: "1.4rem", fontWeight: 700, marginBottom: "10px" }}>Need a Custom Research Topic?</h2>
        <p style={{ color: "#c5d5f0", fontSize: "0.93rem", marginBottom: "20px" }}>Our experts identify unique, researchable topics tailored to your subject, level, and university requirements.</p>

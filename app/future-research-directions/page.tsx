...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: "Future Research Directions — Emerging Academic Topics | Tutors India",
    description: desc || "Explore future research directions and emerging topics across all academic disciplines. Expert insights from Tutors India.",
  ...
  return (
    <>
      ...
      <section style={{ background: "linear-gradient(135deg,#1a2a6c 0%,#2563b0 100%)", color: "#fff", padding: "52px 20px 44px" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          ...
          <p style={{ color: "#c5d5f0", fontSize: "0.97rem", maxWidth: "680px" }}>
            Discover emerging research opportunities and future directions across all academic fields.
          </p>
        </div>
      </section>
      ...
      <section style={{ background: "#f5f6fa", padding: "40px 20px" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
            ...
            <Link href="/topic/" style={{ padding: "10px 20px", border: "1.5px solid #1a2a6c", color: "#1a2a6c", borderRadius: "5px", fontWeight: 600, fontSize: "0.9rem" }}>Dissertation Topics</Link>
            <Link href="/title/" style={{ padding: "10px 20px", border: "1.5px solid #1a2a6c", color: "#1a2a6c", borderRadius: "5px", fontWeight: 600, fontSize: "0.9rem" }}>Dissertation Titles</Link>
          </div>
        </div>
      </section>
      ...
      <section style={{ background: "linear-gradient(135deg,#1a2a6c 0%,#2563b0 100%)", color: "#fff", padding: "48px 20px", textAlign: "center" }}>
        ...
        <p style={{ color: "#c5d5f0", fontSize: "0.93rem", marginBottom: "20px" }}>Our PhD-qualified experts help you identify and develop future-ready research topics.</p>

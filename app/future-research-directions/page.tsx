...
export default async function FutureResearchDirectionsPage() {
  ...
  return (
    <>
      <BreadcrumbSchema items={[{ name: "Home", url: "/" }, { name: "Insights", url: "/insights/" }, { name: "Future Research Directions" , url: "https://www.tutorsindia.com/future-research-directions/" }]} />
      {/* Hero */}

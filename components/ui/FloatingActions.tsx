...
// Tawk's own bubble so this speed-dial's Chat icon is the only entry point.
  ...
  return (
    <>
      ...
      <div className={`float-actions${open ? " is-open" : ""}`}>
        <div className="float-items" aria-hidden={!open}>
          ...
          <button
            ...
            title="Live chat"
            onClick={() => { close(); openChat(); }}
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#2563b0" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <style>{`
        ...
        .float-actions.is-open .float-main { background: #1a2a6c; }
